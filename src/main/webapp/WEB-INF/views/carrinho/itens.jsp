...
<!-- A especificacao diz que deve ser logo após a tag de template 	 -->
<!-- Não deve haver conteúdo (nem mesmo um comentário) entre tags:pageTamplate e as tags jsp:attribute 	 -->
...
<!-- Preciso ter o doBody pois estou usando um Fragment, dessa forma preciso informa onde ficará esse doBody -->
